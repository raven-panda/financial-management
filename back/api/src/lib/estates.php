<?php
    ...
    if ($mysql_connection) {
        if ($request_method === 'GET') {
            ...
            $sql = "SELECT `id`, `name`, `amount`, `date`, `description`, `status`, `roi`, `location`, `duration` FROM `estates`";
            ...
            if (
                ...
                try {
                    ...
                    $sql = "INSERT INTO `estates` (`name`, `amount`, `date`, `description`, `status`, `roi`, `location`, `duration`) VALUES (:name, :amount, :date, :description, :status, :roi, :location, :duration)";
